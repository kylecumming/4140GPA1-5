...
export default class PODetails extends Component {
    ...
    getPOInfomation17() {
        let POdetails = `http://localhost:3000/api/company/y/getPODetail371/${this.state.poNo}`;
        let POLines = `http://localhost:3000/api/company/y/getPOLines371/${this.state.poNo}`;
    ...
    startTransaction371() {
        ...
        Axios.get(`http://localhost:3000/api/company/y/startTransaction371/${this.state.poNo}`).then((response) => {
    ...
    commitTransaction() {
        Axios.get('http://localhost:3000/api/company/y/endTransaction371/commit').then((res) => {
            this.setState({
    ...
    rollbackTransaction() {
        Axios.get('http://localhost:3000/api/company/y/endTransaction371/rollback').then((res) => {
            this.setState({
                transaction: 'rollback_success',
            })
        }).catch((err) => {
